...
<div class="postHeader" style="background: #f2f2f2;text-align: center;padding: 9px;">
    ...
    <a style="padding: 10px;color: #000000;text-decoration: none;background: gray" href="/contragents/change/${contragent.getName()}">Изменить
        контрагента</a>
    <a style="padding: 10px;color: #000000;text-decoration: none;" href="/contragents/deletion/${contragent.getName()}">Удалить
        контрагента</a>
</div>

<h1>Измененение контрагента</h1>
